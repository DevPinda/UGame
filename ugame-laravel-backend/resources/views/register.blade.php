...
<div class = "reg_form">
    <h4 id = "create_account">Create Account</h4>
    <h4 id = "create_account_caption">Enter email and create password.</h4>
    <div class = "group_input_fields">
        <label id = "email_label">Email</label>
        <input class = input_fields id = "email_form" type="text" placeholder="example@gmail.com"><br>
        <label id = "password_label">Password</label>
        <input class = input_fields type="text" placeholder="password"><br>
        <label id = "confirm_label">Confirm</label>
        <input class = input_fields type="text" placeholder="confirm password"><br>
        <button class = "input_fields" id = "signin_button" type="button">REGISTER</button>
