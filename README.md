...
- Developed and populated the database tables [xboxProducts](https://github.com/DevPinda/CS2TP-Group-27-Project-1/blob/main/ugame-laravel-backend/database/migrations/2022_11_28_113733_xbox_products.php), [playstationProducts](https://github.com/DevPinda/CS2TP-Group-27-Project-1/blob/main/ugame-laravel-backend/database/migrations/2022_11_28_105946_playstation_products.php) and [nintendoProducts](https://github.com/DevPinda/CS2TP-Group-27-Project-1/blob/main/ugame-laravel-backend/database/migrations/2022_11_28_120227_nintendo_products.php); then set-up the routing to allow the database table to return to the specified front-end view.
- Setup the functionality to allow [Images](https://github.com/DevPinda/CS2TP-Group-27-Project-1/tree/main/ugame-laravel-backend/public/images) to be displayed in the front-end by storing the image links in the database and then returning, formatting and displaying them in the front-end.
